...
export class ShaderProgram {
  ...
  constructor(gl, option) {
    ...
    if (Array.isArray(this.attribute) !== true || Array.isArray(this.stride) !== true || this.attribute.length !== this.stride.length) {
      throw new Error('attribute or stride does not match')
    }
    if (Array.isArray(this.uniform) === true || Array.isArray(this.type) === true) {
      if (Array.isArray(this.uniform) !== true || Array.isArray(this.type) !== true || this.uniform.length !== this.type.length) {
